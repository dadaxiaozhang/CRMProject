...
<%
    if (request.getParameter("deptName") != null){
        String newDep = request.getParameter("deptName");
...
<form action="${pageContext.request.contextPath}/dept/addDept.action" method="post">
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	 <tr>
	    <td>部门名称：</td>
	    <td>
            <input type="text" name="deptName" value="${editDepNameJsp}"/>
